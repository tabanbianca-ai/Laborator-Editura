...
| RC1-P0-002 | P0 BLOCKER | Deployment | Confirmed resolved | The remediated RC1 artifact was deployed to live staging through the artifact-based release path. A later staging verification issue showed that Docker image ID equality is not the portable gate for the current `docker save/load` path, so repository tooling now verifies artifact/source/migration identity through image configuration labels and running container labels while preserving build-time image IDs as provenance evidence. | Deployment ID: `rc1-30b39ec-20260809`; source commit: `30b39ec0034f335bdbda210f09c8ad66a26a25a2`; artifact SHA-256: `9665892b4600387326d4e569de9fbf3a7f08f9ffb565bfda71664fa89f8c792e`; API image ID evidence: `sha256:e89836ad49f4770a60a921423ea910f8654b1f98254a98acb2d0c7c0ddf6b451`; WEB image ID evidence: `sha256:d941cfe6bc427f529ac20a9d7b1ff33c140eee1fa80551e2bfab141f0adfa42e`; portable runtime gate: release labels and artifact digest. | Preserve artifact-based deployment, verify portable runtime labels, and do not rebuild RC release artifacts in staging. | RESOLVED |
