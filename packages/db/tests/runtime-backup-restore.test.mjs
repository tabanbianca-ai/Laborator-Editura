...
function sampleSnapshot() {
  ...
  snapshot.ai_provider_statuses.push(
    { id: "ai-provider-openai-a", organizationId: "org-a", provider: "OPENAI", displayName: "OpenAI", providerRole: "PRIMARY", status: "AVAILABLE", active: true, priority: 1, configured: true, supportedModels: ["automatic", "gpt-5"], defaultModel: "automatic", modelSelectionMode: "AUTOMATIC", fallbackToProvider: "ANTHROPIC", createdAt: "2026-01-01T00:00:07.045Z", updatedAt: "2026-01-01T00:00:07.045Z", metadata: { extensibleProviderArchitecture: true } },
    { id: "ai-provider-anthropic-a", organizationId: "org-a", provider: "ANTHROPIC", displayName: "Anthropic", providerRole: "FALLBACK", status: "AVAILABLE", active: false, priority: 2, configured: true, supportedModels: ["automatic", "claude"], defaultModel: "automatic", modelSelectionMode: "AUTOMATIC", createdAt: "2026-01-01T00:00:07.046Z", updatedAt: "2026-01-01T00:00:07.046Z", metadata: { fallbackFor: "OPENAI" } }
  );
  snapshot.ai_usage_records.push(
    { id: "ai-usage-a", organizationId: "org-a", agentName: "Translation AI", executionType: "SEGMENT_TRANSLATION_ASSIST", projectId: "project-a", documentId: "document-a", userId: "user-a", providerMetadata: { provider: "OPENAI", model: "automatic" }, inputTokens: 100, outputTokens: 50, totalTokens: 150, estimatedCost: 0.03, actualCost: 0.03, currency: "EUR", status: "SUCCEEDED", costPolicyEvaluation: { softLimitWarning: false, hardLimitReached: false, approvalRequiredOverThreshold: false, blockedActionOnly: true, dataDeleted: false, platformCreatorUnlimited: false }, externalBillingIntegration: "NOT_CONFIGURED", createdAt: "2026-01-01T00:00:07.050Z", metadata: { providerCostApiConnected: false } }
  );
  ...
  snapshot.ai_cost_policies.push(
    { id: "ai-policy-a", organizationId: "org-a", name: "Closed beta AI cost policy", status: "ACTIVE", softLimitWarningThreshold: 0.5, hardLimitMetadata: { maxCostPerRun: 2 }, approvalRequiredOverThreshold: 1, warningThresholds: [80, 90, 100], humanOverrideAllowed: true, aiMayEstimateCost: true, aiMaySuggestOptimizations: true, aiMayWarnBudgetRisk: true, aiMayRecommendQuotaChanges: true, aiCannotApproveOwnBudgetIncrease: true, aiCannotBypassHardLimits: true, aiCannotAlterCostHistory: true, aiCannotDeleteUsageRecords: true, createdBy: "user-a", createdAt: "2026-01-01T00:00:07.080Z", updatedAt: "2026-01-01T00:00:07.080Z", metadata: { externalBillingIntegration: "NOT_CONFIGURED" } }
  );
