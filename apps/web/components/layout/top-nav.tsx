...
export function TopNav({
  ...
  const navigationItems = toNavigationItems(navigation, activePlatformLanguage);
  const ui = createUiTranslator(activePlatformLanguage);
  const language = formatLanguageLocale(activePlatformLanguage);
